...
'publisher_website' => 'https://roadtoinfamy.com/',   

// Board Game Geek ID of the publisher
'publisher_bgg_id' => 39068,
...
'tie_breaker_description' => totranslate("Each tied player rolls all of their unexhausted Servant dice and adds them together. Re-roll ties. The player with the higher result wins."),
...
'player_colors' => array( "262f33", "00808d", "8250a0", "be252e" ),
...
'presentation' => array(
   totranslate("Send your servants down into the crypt to procure the best treasure."),
   totranslate("Place your servant dice on treasure cards, choosing any value on each die. Choosing a higher value can ward off your opponents, but it also increases the odds that your servant will become exhausted. After everyone has placed their servant dice, everyone rolls. If you roll less than your chosen value, you lose the die."),
   totranslate("Sets of treasure can be pawned off to collectors that offer bonus coins and special abilities. The player with the most valuable collection wins!")
),
