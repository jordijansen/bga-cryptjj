...
$this->collectors = [
    ...
    'jewelery' => [
        ...
        'sides' => [
            'A' => [
                'type' => COLLECTOR_END_GAME,
                'description' => totranslate("At game end, players with two or more Jewelry score their highest valued Jewelry twice. For example: if you have two jewelery cards valued 2 and 3 respectively, this collector scores you an additional 3 coins during final scoring."),
                'nrOfCardsToFlip' => 0
            ],
            'B' => [
                'type' => COLLECTOR_END_GAME,
                'description' => totranslate("At game end, all players score 1 bonus Coin for each Jewelry in their collection. For example: if you have two jewelery cards, this collector scores you an additional 2 coins during final scoring."),
                'nrOfCardsToFlip' => 0
            ],
        ]
    ],
    ...
    'tapestry' => [
        ...
        'sides' => [
            'A' => [
                'type' => COLLECTOR_END_GAME,
                'description' => totranslate("At game end, the player whose combined Tapestries are worth the most Coins scores 5 bonus Coins. Tied players each score the full bonus. For example: player X has a combined value of 5 and player Y has a combined value of 6, player Y scores an additional 5 coins for this collector during final scoring."),
                'nrOfCardsToFlip' => 0
            ],
            'B' => [
                'type' => COLLECTOR_END_GAME,
                'description' => totranslate("At game end, if only one player has three or more Tapestries, they score 7 bonus Coins. If more than one player collects three or more Tapestries, each player scores 4 bonus Coins. For example: player X has 2 Tapestry cards and player Y has 3 Tapestry Cards, player Y scores an additional 7 coins during final scoring."),
                'nrOfCardsToFlip' => 0
            ],
        ]
    ],
