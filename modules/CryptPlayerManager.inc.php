...
class CryptPlayerManager extends APP_DbObject
{
    ...
    public function getPlayersInTurnOrder() {
        return self::getCollectionFromDb("SELECT player_id, player_score as score, player_name, player_color, player_zombie, custom_order, has_used_manuscript_b_this_round, has_played_before_this_round, player_card_side FROM player ORDER BY custom_order DESC");
    }
